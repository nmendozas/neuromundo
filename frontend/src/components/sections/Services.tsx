          ...
          {services.map((service, index) => (
            <Reveal key={service.id} delay={(index % 3) * 0.08}>
              <motion.article
                ...
                className="group relative flex h-full flex-col rounded-2xl border border-slate-100 bg-white p-8 shadow-card transition-shadow hover:shadow-xl"
              >
                <span className="pointer-events-none absolute right-6 top-4 font-display text-6xl font-bold text-slate-100 transition-colors group-hover:text-clinical-100">
                  {service.num}
                </span>

                <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-clinical-50 text-clinical-600 transition-colors group-hover:bg-clinical-500 group-hover:text-white">
                ...
                <div className="relative mt-6 flex items-center justify-between">
                  ...
                  <a href="#contacto" className="inline-flex items-center gap-1.5 text-sm font-semibold text-navy-700 transition-colors group-hover:text-clinical-600">
                    Cotizar
